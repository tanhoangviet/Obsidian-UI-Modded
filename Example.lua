...
LeftGroupBox:AddLiquidGlassButton({
    ...
    Callback = function()
        local Loading = Library:CreateLoading({
            ...
            Decor = true,
            DecorImage = RepoAsset("assets/PixelLoadingDecorV2.png"),
            DecorImageTransparency = 0.3,
            DecorPosition = "Full",
            ProgressTextureImage = Library.ImageManager.GetAsset("LoadingBarPixelTextureV2"),
            ProgressTextureTransparency = 0,
            ProgressTextureTileSize = UDim2.fromOffset(192, 16),
            ProgressTrackTexture = true,
            ProgressTrackTextureTransparency = 0.55,
            ...
            Drawings = {
                {
                    ...
                    Image = RepoAsset("assets/LoadingBarPixelTextureV2.png"),

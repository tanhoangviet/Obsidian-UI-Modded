...
LeftGroupBox:AddLiquidGlassButton({
    ...
    Callback = function()
        local Loading = Library:CreateLoading({
            ...
            Decor = true,
            DecorImage = Library.ImageManager.GetAsset("LoadingPanelFrame1"),
            DecorFrames = {
                Library.ImageManager.GetAsset("LoadingPanelFrame1"),
                Library.ImageManager.GetAsset("LoadingPanelFrame2"),
                Library.ImageManager.GetAsset("LoadingPanelFrame3"),
                Library.ImageManager.GetAsset("LoadingPanelFrame4"),
            },
            DecorFrameRate = 8,
            ...
            ProgressTrackTextureTransparency = 0.42,
            ...
            ProgressShine = true,
            ProgressShineTransparency = 0.24,
            ProgressShineWidth = 86,
            ProgressShineSpeed = 1.05,
